...
def user_input_features():
    ...
    data['Age'] = age  # Assuming 'Age' is a feature in your model

    # Handling categorical data: Sex
...
def main():
    ...
    navigation = st.sidebar.radio("Navigate", ["Home", "Data Info", "Case Outcome Visuals", "FAQ", "Models and Predictions"])
